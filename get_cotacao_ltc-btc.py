...
url = 'https://rest.coinapi.io/v1/exchangerate/LTC/BTC/history?limit=5&period_id=1HRS&time_start={}&time_end={}'.format(start.strftime("%Y-%m-%dT%H:%M:%S"),end.strftime("%Y-%m-%dT%H:%M:%S"))
